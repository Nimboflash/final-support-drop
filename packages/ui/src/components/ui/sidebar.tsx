    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          side === "left"
            ? // eslint-disable-next-line drop/no-physical-direction-classes -- the side prop pins the fixed container to a physical viewport edge (data-side is physical by design); the offcanvas off-screen offset must leave through that same physical edge
          ...
          variant === "floating" || variant === "inset"
            ...
            : // eslint-disable-next-line drop/no-physical-direction-classes -- data-side selectors carry physical values; the inner border sits on the content-facing edge of whichever physical side the sidebar is pinned to
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      title="نمایش یا پنهان‌کردن منو"
      className={cn(
        // eslint-disable-next-line drop/no-physical-direction-classes -- the rail straddles the sidebar's physical edge: offsets are keyed to physical data-side values and centered with a physical translate-x pair
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border sm:flex",
        "in-data-[side=left]:cursor-w-resize in-data-[side=right]:cursor-e-resize",
        "[[data-side=left][data-state=collapsed]_&]:cursor-e-resize [[data-side=right][data-state=collapsed]_&]:cursor-w-resize",
        // eslint-disable-next-line drop/no-physical-direction-classes -- offcanvas hover strip hugs the physical edge the sidebar left through (left-full tracks the physical rail geometry above)
        "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full hover:group-data-[collapsible=offcanvas]:bg-sidebar",
        // eslint-disable-next-line drop/no-physical-direction-classes -- offset keyed to the physical data-side=left edge
        "[[data-side=left][data-collapsible=offcanvas]_&]:-right-2",
        // eslint-disable-next-line drop/no-physical-direction-classes -- offset keyed to the physical data-side=right edge
