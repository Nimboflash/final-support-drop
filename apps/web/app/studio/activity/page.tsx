...
import { ActivitySkeleton } from "../../../components/panel/skeletons";
...
function Surface() {
  ...
  return <QueryBoundary query={query} pending={<ActivitySkeleton />}>{(world) => <ActivityPage world={world} />}</QueryBoundary>;
}
